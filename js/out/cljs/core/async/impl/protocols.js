...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26978 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26978.call(null,port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26979 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26979.call(null,port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26980 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26980.call(null,chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26981 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26981.call(null,chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26982 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26982.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26983 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26983.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26984 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26984.call(null,h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26985 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26985.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26986 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26986.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26987 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26987.call(null,b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26988 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26988.call(null,b);
}
});
...
//# sourceMappingURL=protocols.js.map?rel=1644716832547
