...
var o23309 = temp__5751__auto__;
var temp__5751__auto____$1 = (o23309["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o23310 = temp__5751__auto____$1;
return (o23310["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22636__auto__ = f;
return (o__22636__auto__["toString"]).call(o__22636__auto__);
} else {
return "";
}
}catch (e23311){var _ = e23311;
return "";
}});
...
try{var o__22636__auto___23313 = t;
(o__22636__auto___23313["cljs$lang$ctorPrWriter"]).call(o__22636__auto___23313,t,writer);
}catch (e23312){var __23314 = e23312;
}
...
var char_code = (function (){var o__22636__auto__ = (new String(char$));
return (o__22636__auto__["charCodeAt"]).call(o__22636__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22636__auto__ = String;
return (o__22636__auto__["fromCharCode"]).call(o__22636__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23315 = num_code;
switch (G__23315) {
case (1):
return (185);
...
var o__22636__auto__ = String;
return (o__22636__auto__["fromCharCode"]).call(o__22636__auto__,superscript_code);
});
/**
...
}catch (e23317){var _e__22643__auto__ = e23317;
return false;
}})())){
...
var vec__23318 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23318,(0),null);
...
var len__4864__auto___23327 = arguments.length;
var i__4865__auto___23328 = (0);
while(true){
if((i__4865__auto___23328 < len__4864__auto___23327)){
args__4870__auto__.push((arguments[i__4865__auto___23328]));

var G__23329 = (i__4865__auto___23328 + (1));
i__4865__auto___23328 = G__23329;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23323){
var vec__23324 = p__23323;
var ns_detector = cljs.core.nth.call(null,vec__23324,(0),null);
...
var G__23330 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23331 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23330;
remaining_tokens = G__23331;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23321){
var G__23322 = cljs.core.first.call(null,seq23321);
var seq23321__$1 = cljs.core.next.call(null,seq23321);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23322,seq23321__$1);
}));
...
var vec__23335 = cljs.core.split_with.call(null,(function (p1__23334_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23334_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23335,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23335,(1),null);
...
var vec__23341 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23341,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23341,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23344 = cljs.core.rest.call(null,remaining_tokens);
var G__23345 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23344;
name_tokens = G__23345;
continue;
} else {
...
var vec__23348 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23348,(0),null);
var arity = cljs.core.nth.call(null,vec__23348,(1),null);
var vec__23351 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23351,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23351,(1),null);
var vec__23354 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23354,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23354,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23354,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23354,(3),null);
...
var vec__23360 = result;
var munged_ns = cljs.core.nth.call(null,vec__23360,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23360,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23360,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23360,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23360,(4),null);
var arity = cljs.core.nth.call(null,vec__23360,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__23364 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__23364,(0),null);
var args = cljs.core.nth.call(null,vec__23364,(1),null);
var vec__23367 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23367,(0),null);
var name = cljs.core.nth.call(null,vec__23367,(1),null);
...
var G__23370 = (arity + (1));
var G__23371 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23372){
var vec__23373 = p__23372;
var arity = cljs.core.nth.call(null,vec__23373,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23373,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23376_SHARP_){
return cljs.core.get.call(null,arities,p1__23376_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__23377_SHARP_){
return cljs.core.drop.call(null,(2),p1__23377_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___23384 = arguments.length;
var i__4865__auto___23385 = (0);
while(true){
if((i__4865__auto___23385 < len__4864__auto___23384)){
args__4870__auto__.push((arguments[i__4865__auto___23385]));

var G__23386 = (i__4865__auto___23385 + (1));
i__4865__auto___23385 = G__23386;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23380){
var vec__23381 = p__23380;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23381,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23378){
var G__23379 = cljs.core.first.call(null,seq23378);
var seq23378__$1 = cljs.core.next.call(null,seq23378);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23379,seq23378__$1);
}));
...
var map__23389 = options;
var map__23389__$1 = cljs.core.__destructure_map.call(null,map__23389);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23389__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23389__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23389__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23389__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23390 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23390,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23390,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23390,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23390,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23390,(4),null);
var arity = cljs.core.nth.call(null,vec__23390,(5),null);
...
var o__22636__auto__ = f;
return (o__22636__auto__["getBasis"]).call(o__22636__auto__);
});
/**
...
}catch (e23393){var _e__22643__auto__ = e23393;
...
var G__23394 = (obj[cljs.core.first.call(null,path)]);
var G__23395 = cljs.core.rest.call(null,path);
obj = G__23394;
path = G__23395;
continue;
} else {
...
var _STAR_ = (function (accum,p__23396){
var vec__23397 = p__23396;
var bit = cljs.core.nth.call(null,vec__23397,(0),null);
var protocol = cljs.core.nth.call(null,vec__23397,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23400){
var vec__23401 = p__23400;
var ns = cljs.core.nth.call(null,vec__23401,(0),null);
var name = cljs.core.nth.call(null,vec__23401,(1),null);
var selector = cljs.core.nth.call(null,vec__23401,(2),null);
...
var post_process = (function (p__23405){
var vec__23406 = p__23405;
var munged_name = cljs.core.nth.call(null,vec__23406,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23406,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23404_SHARP_){
return (obj[cljs.core.first.call(null,p1__23404_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1644716826421
