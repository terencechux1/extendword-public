...
var len__4864__auto___23436 = arguments.length;
var i__4865__auto___23437 = (0);
while(true){
if((i__4865__auto___23437 < len__4864__auto___23436)){
args__4870__auto__.push((arguments[i__4865__auto___23437]));

var G__23438 = (i__4865__auto___23437 + (1));
i__4865__auto___23437 = G__23438;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23433){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23434,G__23435,seq23433__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23439_SHARP_){
return (!((cljs.core.meta.call(null,p1__23439_SHARP_) == null)));
})))){
...
var map__23440 = opts;
var map__23440__$1 = cljs.core.__destructure_map.call(null,map__23440);
var markup_db = cljs.core.get.call(null,map__23440__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23441){var _e__22643__auto__ = e23441;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e23443){var _e__22643__auto__ = e23443;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23445 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23446 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23446);

try{var map__23447 = opts;
var map__23447__$1 = cljs.core.__destructure_map.call(null,map__23447);
var markup_db = cljs.core.get.call(null,map__23447__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23445);
}});
...
var temp__5751__auto___23451 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5751__auto___23451)){
var managed_print_level_23452 = temp__5751__auto___23451;
var _STAR_print_level_STAR__orig_val__23449_23453 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23450_23454 = managed_print_level_23452;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23450_23454);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__23448_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23448_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23449_23453);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1644716826629
