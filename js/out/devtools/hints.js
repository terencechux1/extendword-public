...
var temp__5751__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
...
var reader = (function (){var or__4253__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4253__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return (128);
...
var map__26109 = top_item;
var map__26109__$1 = cljs.core.__destructure_map.call(null,map__26109);
var file = cljs.core.get.call(null,map__26109__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26109__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26109__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26108){var _e = e26108;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___26110 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___26110)){
var seen_errors_26111 = temp__5751__auto___26110;
if(cljs.core.truth_(seen_errors_26111.has(self))){
} else {
seen_errors_26111.add(self);

var temp__5753__auto___26112 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___26112)){
var sense_26113 = temp__5753__auto___26112;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26113)].join(''));
} else {
}
}
} else {
...
var temp__5753__auto__ = devtools.hints.error_object_sense.call(null,error);
...
//# sourceMappingURL=hints.js.map?rel=1644716831741
