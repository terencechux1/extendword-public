...
return (new CustomEvent(event_name,(function (){var obj30767 = ({"detail":data});
return obj30767;
})()));
} else {
...
var f = (function (){var pred__30774 = cljs.core._EQ_;
var expr__30775 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30774.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30775))){
return (function (p1__30768_SHARP_){
return console.warn(p1__30768_SHARP_);
});
} else {
if(cljs.core.truth_(pred__30774.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30775))){
return (function (p1__30769_SHARP_){
return console.debug(p1__30769_SHARP_);
});
} else {
if(cljs.core.truth_(pred__30774.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30775))){
return (function (p1__30770_SHARP_){
return console.error(p1__30770_SHARP_);
});
} else {
return (function (p1__30771_SHARP_){
return console.log(p1__30771_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30778){
var map__30779 = p__30778;
var map__30779__$1 = cljs.core.__destructure_map.call(null,map__30779);
var opts = map__30779__$1;
var eval_fn = cljs.core.get.call(null,map__30779__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__30780_SHARP_){
return new_def.callback(p1__30780_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__30781){
var vec__30782 = p__30781;
var ky = cljs.core.nth.call(null,vec__30782,(0),null);
...
}catch (e30787){if((e30787 instanceof Error)){
var e = e30787;
return not_found;
} else {
throw e30787;
...
//# sourceMappingURL=utils.js.map?rel=1644716834059
