...
return cljs.core.reduce.call(null,(function (result,p__24815){
...
var vec__24819 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24819,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24819,(1),null);
var ab = cljs.core.nth.call(null,vec__24819,(2),null);
...
return clojure$data$EqualityPartition$equality_partition$dyn_24825.call(null,x);
}
});
...
return clojure$data$Diff$diff_similar$dyn_24826.call(null,a,b);
}
});
...
return (function (){var G__24830 = clojure.data.equality_partition.call(null,a);
var G__24830__$1 = (((G__24830 instanceof cljs.core.Keyword))?G__24830.fqn:null);
switch (G__24830__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24830__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1644716827717
