...
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__25723 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__25723,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__25724__delegate = function (args){
...
while (G__25725__i < G__25725__a.length) {G__25725__a[G__25725__i] = arguments[G__25725__i + 0]; ++G__25725__i;}
  args = new cljs.core.IndexedSeq(G__25725__a,0,null);
} 
return G__25724__delegate.call(this,args);};
...
return G__25724__delegate(args);
});
...
var G__25727 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__25727,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__25728__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__25729__i < G__25729__a.length) {G__25729__a[G__25729__i] = arguments[G__25729__i + 0]; ++G__25729__i;}
  args = new cljs.core.IndexedSeq(G__25729__a,0,null);
} 
return G__25728__delegate.call(this,args);};
G__25728.cljs$lang$maxFixedArity = 0;
G__25728.cljs$lang$applyTo = (function (arglist__25730){
var args = cljs.core.seq(arglist__25730);
return G__25728__delegate(args);
});
...
var G__25731 = props;
var G__25731__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25731,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25731);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25731__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__25732 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25732,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__25732;
}
})(),id_class);
...
var G__25733 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25733) {
case (0):
...
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__25735 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25735,(0),null);
var id = cljs.core.nth.call(null,vec__25735,(1),null);
var className = cljs.core.nth.call(null,vec__25735,(2),null);
...
var temp__5757__auto___25738 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___25738 == null)){
} else {
var key_25739 = temp__5757__auto___25738;
(jsprops.key = key_25739);
}
...
var temp__5757__auto___25740 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___25740 == null)){
} else {
var key_25741 = temp__5757__auto___25740;
(jsprops.key = key_25741);
}
...
var jsprops = (function (){var or__4253__auto__ = reagent.impl.template.convert_prop_value.call(null,((hasprops)?props:null));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return ({});
...
var temp__5757__auto___25742 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___25742 == null)){
} else {
var key_25743 = temp__5757__auto___25742;
(jsprops.key = key_25743);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_.call(null,props)));
var jsprops = (function (){var or__4253__auto__ = reagent.impl.template.convert_props.call(null,((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return ({});
...
var temp__5757__auto___25744 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___25744 == null)){
} else {
var key_25745 = temp__5757__auto___25744;
(jsprops.key = key_25745);
}
...
var temp__5757__auto___25746 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___25746 == null)){
} else {
var key_25747 = temp__5757__auto___25746;
(jsprops.key = key_25747);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__25748_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__25748_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__25749 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__25749,(0),null);
var derefed = cljs.core.nth.call(null,vec__25749,(1),null);
...
break;
default:
var G__25754 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__25755 = compiler;
v = G__25754;
compiler = G__25755;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template25759 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template25759 = (function (opts,id,fn_to_element,parse_fn,meta25760){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template25759.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25761,meta25760__$1){
var self__ = this;
var _25761__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25759(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25760__$1));
}));

(reagent.impl.template.t_reagent$impl$template25759.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25761){
var self__ = this;
var _25761__$1 = this;
return self__.meta25760;
}));

(reagent.impl.template.t_reagent$impl$template25759.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25759.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25759.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template25759.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25759.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25759.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25760","meta25760",-1677104086,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25759.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25759.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25759");

(reagent.impl.template.t_reagent$impl$template25759.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template25759");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25759.
 */
reagent.impl.template.__GT_t_reagent$impl$template25759 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template25759(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta25760){
return (new reagent.impl.template.t_reagent$impl$template25759(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta25760));
});

}

return (new reagent.impl.template.t_reagent$impl$template25759(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1644716828823
